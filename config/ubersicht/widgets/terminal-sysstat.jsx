...
export const className = `
  ...
  top: 422px; right: 171px; width: 340px; height: 584px;
...
function Row({ label, labelColor, barStr, barColor, value, valueColor }) {
  return (
    <div style={{ display: 'flex', alignItems: 'baseline', marginBottom: 4, fontSize: 15, gap: 6 }}>
...
function Sep({ label }) {
  return <div style={{ fontSize: 12, color: 'var(--indigo)', margin: '4px 0 3px' }}>{'\u2500 ' + label + ' '}{'\u2500'.repeat(20)}</div>
}
...
export const render = ({ output }) => {
  ...
  return (
    <Window title="sysstat">
      ...
      <Sep label="net" />
      <div style={{ display: 'flex', alignItems: 'baseline', marginBottom: 3, fontSize: 15, gap: 6 }}>
